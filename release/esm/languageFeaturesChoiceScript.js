 ...
 *--------------------------------------------------------------------------------------------*/
import * as choicescriptService from './_deps/vscode-choicescript-languageservice/cssLanguageService';
import { languages, editor, Uri, Position, Range, MarkerSeverity } from './fillers/monaco-editor-core';
// --- diagnostics --- ---
